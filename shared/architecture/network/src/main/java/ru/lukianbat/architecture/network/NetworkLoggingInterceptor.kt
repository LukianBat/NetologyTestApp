package ru.lukianbat.architecture.network
...
class NetworkLoggingInterceptor constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        var requestMessage =
            "-->  ${request.method} ${request.url} ${connection?.protocol() ?: ' '}\n"
    ...
    companion object {
        ...
        private val DEFAULT: (message: String) -> Unit =
            { message -> Platform.get().log(message, Platform.INFO, null) }
    }
}
